# to create a virtual environment write code as :- python -m venv name_of_venv
# to activate virtual environment write code as :- .\venv\Scripts\activate
# to deactivate venv write in terminal :- deactivate
...
st.sidebar.image('https://img.olympics.com/images/image/private/t_social_share_thumb/f_auto/primary/mmdfgqbwukdh3hmvs5rn')
